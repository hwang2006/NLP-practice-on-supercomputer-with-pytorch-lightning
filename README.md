...
This repo is intended to share best practices for fine-tuning pretrained models (e.g., BERT and GPT-2) running across multiple GPU nodes on a supercomputer managed by SLURM.    
